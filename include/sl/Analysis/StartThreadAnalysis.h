...
class StartThreadAnalysis : public clang::RecursiveASTVisitor<StartThreadAnalysis> {
 private:
  clang::ASTContext &astContext;  // used for getting additional AST info

  bool contextStartsNothing; // true while visiting a function declaring starts nothing
